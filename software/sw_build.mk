...
GET_SUT_CONF_PARAM = $(call GET_PARAM,IOB_SOC_SUT_$(1),../src/iob_soc_sut_conf.vh)

iob_soc_sut_boot.hex: ../../software/embedded/iob_soc_sut_boot.bin
	../../scripts/makehex.py $< $(call GET_SUT_CONF_PARAM,BOOTROM_ADDR_W) > $@

iob_soc_sut_firmware.hex: iob_soc_sut_firmware.bin
	../../scripts/makehex.py $< $(call GET_SUT_CONF_PARAM,SRAM_ADDR_W) > $@

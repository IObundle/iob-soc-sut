...
set_property IOB TRUE [get_cells iob_soc_tester0/SPI0/fl_spi0/dq_out_r_reg[0]]
set_property IOB TRUE [get_cells iob_soc_tester0/SPI0/fl_spi0/dq_out_r_reg[1]]
set_property IOB TRUE [get_cells iob_soc_tester0/SPI0/fl_spi0/dq_out_r_reg[2]]
set_property IOB TRUE [get_cells iob_soc_tester0/SPI0/fl_spi0/dq_out_r_reg[3]]

#
# SUT SPI
# Set IOSTANDARD but do not connect to PINs
#

# CS
set_property IOSTANDARD LVCMOS18 [get_ports sut_spi_SS_o]
# CLK
set_property IOSTANDARD LVCMOS18 [get_ports sut_spi_SCLK_o]
# DQ0
set_property IOSTANDARD LVCMOS18 [get_ports sut_spi_MOSI_io]
# DQ1
set_property IOSTANDARD LVCMOS18 [get_ports sut_spi_MISO_io]
# DQ2
set_property IOSTANDARD LVCMOS18 [get_ports sut_spi_WP_N_io]
# DQ3
set_property IOSTANDARD LVCMOS18 [get_ports sut_spi_HOLD_N_io]

set_property IOB TRUE [get_ports sut_spi_SS_o]
set_property IOB TRUE [get_ports sut_spi_SCLK_o]
set_property IOB TRUE [get_cells iob_soc_tester0/SUT0/SPI0/fl_spi0/dq_out_r_reg[0]]
set_property IOB TRUE [get_cells iob_soc_tester0/SUT0/SPI0/fl_spi0/dq_out_r_reg[1]]
set_property IOB TRUE [get_cells iob_soc_tester0/SUT0/SPI0/fl_spi0/dq_out_r_reg[2]]
set_property IOB TRUE [get_cells iob_soc_tester0/SUT0/SPI0/fl_spi0/dq_out_r_reg[3]]
